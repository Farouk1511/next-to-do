...
export default function Home() {
  ...
  return (
    <main className="bg-black h-screen flex flex-col items-center font-mono center text-white overflow-y-auto overflow-x-hidden">
      {/* Header */}
      <div className="flex justify-between w-full sm:px-4 md:px-12 py-6">
      ...
      {/* Main todo box */}
      <div className="flex center justify-center border-2 border-slate-500 rounded-lg w-full sm:w-5/6 md:w-1/3 h-40 py-5">
        <div className="flex justify-between w-full px-4 sm:px-5 md:px-10 items-center">
          ...
          <div className="rounded-full w-12 sm:w-16 md:w-24 h-12 sm:h-16 md:h-24 flex items-center justify-center bg-orange-700 text-sm sm:text-lg md:text-4xl font-extrabold text-black">
