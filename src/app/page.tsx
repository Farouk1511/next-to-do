...
export default function Home() {
  ...
  return (
    <main className="bg-black h-screen flex flex-col items-center font-mono center text-white overflow-y-auto overflow-x-hidden">
      {/* Header */}
      <div className="flex justify-between w-full md:px-12 py-6">
      ...
      {/* Main todo box */}
      <div className="flex center justify-center border-2 border-slate-500 rounded-lg w-full md:w-1/3 h-40 py-5">
        <div className="flex justify-between w-full px-5 md:px-10 items-center">
          <div>
            <p className="text-lg md:text-3xl font-bold">Todo Done</p>
            <span className="tracking-widest">Keep it up</span>
          </div>

          <div className="rounded-full w-16 md:w-24 h-16 md:h-24 flex items-center justify-center bg-orange-700 text-lg md:text-4xl font-extrabold text-black">
      ...
      {/* TO DO LIST */}
      <div className="mt-6 md:mt-12 w-full flex items-center justify-center flex-col space-y-4">
